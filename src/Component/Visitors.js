                ...
                <div className="w-10/12 flex flex-col  bg-gray-200">
                    <div className="flex px-12 bg-white h-1/6 py-4 items-center justify-between">
                        <div className="w-full  flex  items-center justify-between">
                            <h1 className="text-black text-lg font-semibold">Visitors</h1>
                            ...
                            <div className="border-r-1 border-black h-full ">
                              &nbsp;
                            </div>
                            ...
                            <div className="w-3/12 flex justify-between gap-4">
                                ...
                                <div className="flex flex-col">
                                    <h4>Giovanni</h4>
                                    <p className="text-xs -mt-2">Superadmin</p>
                                </div>

                                <div className=" border rounded-3xl px-2 h-9 flex justify-center items-center">
